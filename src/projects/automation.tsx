    ...
    return (
        <main className="relative min-h-screen text-white">
            ...
            <section className="mx-auto max-w-5xl px-4 sm:px-6 py-16 sm:py-20">
                ...
                <h1 className="mt-2 text-3xl sm:text-4xl font-semibold">Nos programmes automatisés</h1>
                <p className="mt-3 text-sm sm:text-base text-zinc-300">
                    Des processus qui connectent vos outils et font gagner un temps précieux.
                </p>
            </section>
            <Footer />
        </main>
